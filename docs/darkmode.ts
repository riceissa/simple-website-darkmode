...
namespace darkmode {
    ...
    function set_root_color_scheme(color: string): void {
        if (color === "dark") {
    ...
    function set_visual_feedback_color(color: string): void {
    ...
    function add_darkmode_menu(): void {
    ...
    function set_theme_from_local_storage(): void {
        add_darkmode_menu();
    ...
    function set_body_class(color: string): void {
        if (color === "dark") {
    ...
    function recompute_body_class(): void {
    ...
    // clicked.
    export function set_color(color: string): void {
